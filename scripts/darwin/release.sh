...
if ! [ -f icon/darwin/icon.icns ]; then
    ...
    sips -z 128 128 ../icon.png --out icon_64x64@2x.png
...
cp icon/darwin/icon.icns release/darwin/Firecrypt.app/Contents/Resources/icon.icns

cp -r ui/* release/darwin/Firecrypt.app/Contents/Resources

go clean --cache
go build -tags release -o release/darwin/Firecrypt.app/Contents/MacOS/firecrypt .
